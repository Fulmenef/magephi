...
class BackupCommand extends AbstractEnvironmentCommand
{
    ...
    protected function configure(): void
    {
        ...
        $this
            ...
            ->setHelp('This command allows backup your environment');
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        try {
            ...
            $command = [
                ...
                '--volume $(pwd):/backup',
                'busybox sh -c "tar cvf /backup/' . self::MYSQL_BACKUP_FILE . ' /var/lib/mysql"',
            ];
            ...
            $command = [
                'docker run --rm',
                '--volume $(pwd):/backup',
                'busybox sh -c "tar cvf /backup/' . $filename . ' /backup/' . self::MYSQL_BACKUP_FILE . ' /backup/'
            ...
            $this->interactive->error(
                'Seems like the backup process exceeded the default timeout of ' . (self::DEFAULT_TIMEOUT / 60)
